...
If ( $PackagesFound.Values -notcontains $False) {
    ...
    Write-Host "All required versions of Microsoft Visual C++ were found and Noname can be installed."
...
Write-Host "`nIIS Version Information (Info: Noname requires IIS 10)"
